...
class MongoDB\Collection implements Stringish {
    ...
    public function count($filter = array (), array $options = array ()): int;
    public function createIndex($key, array $options = array ());
    public function createIndexes(array $indexes);
    public function deleteMany($filter, array $options = array ()): MongoDB\DeleteResult;
    public function deleteOne($filter, array $options = array ()): MongoDB\DeleteResult;
    public function distinct($fieldName, $filter = array (), array $options = array ());
    public function drop(array $options = array ());
    public function dropIndex($indexName, array $options = array ()): ?array;
    public function dropIndexes(array $options = array ()): ?array;
    ...
    public function findOneAndDelete($filter, array $options = array ()): ?array;
    public function findOneAndReplace($filter, $replacement, array $options = array ()): ?array;
    public function findOneAndUpdate($filter, $update, array $options = array ()): ?array;
    public function getCollectionName(): string;
    public function getDatabaseName(): string;
    public function getNamespace(): string;
    public function insertMany(array $documents, array $options = array ()): MongoDB\InsertManyResult;
    public function insertOne($document, array $options = array ()): MongoDB\InsertOneResult;
    public function listIndexes(array $options = array ());
    public function replaceOne($filter, $replacement, array $options = array ()): ?array;
    public function updateMany($filter, $update, array $options = array ()): MongoDB\UpdateResult;
    public function updateOne($filter, $update, array $options = array ()): MongoDB\UpdateResult;
